...
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">
    <asp:GridView ID="gvProducts" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ProductID" DataSourceID="sqlProducts" EnableModelValidation="True">
        <Columns>
    ...
    <asp:DetailsView ID="dvProducts" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataSourceID="sqlProducts" EnableModelValidation="True">
        <Fields>
